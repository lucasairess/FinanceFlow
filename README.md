...
- **Vanilla CSS (CSS3):** Variáveis e tokens avançados via Design System customizado (`styles.css`), garantindo estética harmoniosa e micro animações ricas sem o uso do Tailwind.
- **Vanilla JavaScript (ES6+):** Utilizado em toda parte lógica (`app.js`) para formatar dados, persistir informações no Local Storage, manipular interações modais etc.
